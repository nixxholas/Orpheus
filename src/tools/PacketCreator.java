...
public class PacketCreator {
	...
	private static void addPartyStatus(PacketWriter w, int forchannel, MapleParty party, boolean leaving) {
	...
	private static void getGuildInfo(PacketWriter w, MapleGuild guild) {
